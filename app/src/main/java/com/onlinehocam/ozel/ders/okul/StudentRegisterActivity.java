...
public class StudentRegisterActivity extends AppCompatActivity {
    ...
    EditText editTextStudentName, editTextStudentSurname, editTextBirthDate, editTextPhoneNumber, editTextLastSchool, editTextDepartment;
    ...
    CheckBox checkboxIReadAndAcceptUserAgreement;
    ...
    //INFO Fields
    String name, surname, gender, birthDate, phoneNumber, lastSchool, educationField, classSelections = "";
    int photoID = -1;
    int userID = -1;
    int educationalAttainment = -1;
    int cityOfResidency = -1;
    int districtOfResidency = -1;
    int cityOfRegistry = -1;
    int districtOfRegistry = -1;
        ...
        spinnerEducationalAttainment.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                else
                {
                    ...
                    //GlobalVariables.Log(getApplicationContext(), "educationalAttainment set as: "+educationalAttainment);
                }
            }
    ...
    private void HandleSpinnersOnPlaceOfResidency()
    {
        ...
        spinnerCityOfResidency.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                {
                    cityOfResidency = -1;
                    arrayAdapterDistrictOfResidency = new ArrayAdapter(StudentRegisterActivity.this, android.R.layout.simple_spinner_item, new String[]{ getString(R.string.register_please_select_city_first) });
                    spinnerDistrictOfResidency.setAdapter(arrayAdapterDistrictOfResidency);
                }
                else
                {
                    ...
                    arrayAdapterDistrictOfResidency = new ArrayAdapter(StudentRegisterActivity.this, android.R.layout.simple_spinner_item, CommonUtils.GetSpinnerStringArrayWithHeaderTitle(spinnerDistrictOfResidency, crDistricts, "") );
                    spinnerDistrictOfResidency.setAdapter(arrayAdapterDistrictOfResidency);
                }
            }
    ...
    private void HandleSpinnersOnPlaceOfRegistry()
    {
        ...
        spinnerCityOfRegistry.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                {
                    cityOfRegistry = -1;
                    arrayAdapterDistrictOfRegistry = new ArrayAdapter(StudentRegisterActivity.this, android.R.layout.simple_spinner_item, new String[]{ getString(R.string.register_please_select_city_first) });
                    spinnerDistrictOfRegistry.setAdapter(arrayAdapterDistrictOfRegistry);
                }
                else
                {
                    ...
                    arrayAdapterDistrictOfRegistry = new ArrayAdapter(StudentRegisterActivity.this, android.R.layout.simple_spinner_item, CommonUtils.GetSpinnerStringArrayWithHeaderTitle(spinnerDistrictOfRegistry, crDistricts, "") );
                    spinnerDistrictOfRegistry.setAdapter(arrayAdapterDistrictOfRegistry);
                }
            }
    ...
    private void InitializeComponents()
    {
        ...
        FormatPhoneNumber(editTextPhoneNumber);
    ...
    {
        LinearLayout linearLayoutLessonsPanelLeft = findViewById(R.id.linearLayoutLessonsPanelLeft);
        LinearLayout linearLayoutLessonsPanelRight = findViewById(R.id.linearLayoutLessonsPanelRight);
        checkBoxesLessonsToPick = new CheckBox[LessonsAndClasses.CLASS_NAMES.length];
        for(int i = 0; i < checkBoxesLessonsToPick.length; i++)
        {
            CheckBox crCheckBox = new CheckBox(this);
            crCheckBox.setText(LessonsAndClasses.CLASS_NAMES[i]);
            checkBoxesLessonsToPick[i]= crCheckBox;
            if(i%2==0)
            {
                linearLayoutLessonsPanelLeft.addView(crCheckBox);
            }
            else
            {
                linearLayoutLessonsPanelRight.addView(crCheckBox);
            }
        }
    }
    ...
    private void SetOnClickListeners()
    {
        imageViewPhoto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    new CustomToast(StudentRegisterActivity.this, getApplicationContext(), getString(R.string.post_question_please_upload_question_photo));
                }
            }
        });
        buttonTakePhoto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    new CustomToast(StudentRegisterActivity.this, getApplicationContext(), getString(R.string.permission_check_camera_permission_is_needed));
                }
            }
        });
        buttonImportPhoto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    new CustomToast(StudentRegisterActivity.this, getApplicationContext(), getString(R.string.permission_check_read_external_storage_permission_is_needed));
                }
            }
        });
        ...
        buttonRegisterUser.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                else
                {
                    ...
                    i.putExtra("isFirstHomePageLunch", true);
                    startActivity(i);
                }
            }
        });
        ...
        textViewReadUserAgreement.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                GlobalVariables.AlertDialogDisplay(StudentRegisterActivity.this, GlobalVariables.STUDENT_USER_AGREEMENT);
            }
        });
    }
    ...
    private void CheckIfFieldsFilledAndExecuteRegisteringUserIfNeeded()
    {
        ...
        surname = editTextStudentSurname.getText().toString();
        gender = "";
        ...
        classSelections = GetLessonsToStudy();
        if(!isPhotoUploaded)
        {
            photoImage = null;
        }
        ...
        {
            warningMessage = getString(R.string.register_warning_please) + " " + (getString(R.string.register_student_prefered_classes_for_studying)).substring(0,getString(R.string.register_student_prefered_classes_for_studying).length()-1) + " " + getString(R.string.fill_the_field);
            new CustomToast(this, getApplicationContext(), warningMessage);
        }
    ...
    private String GetLessonsToStudy()
    {
        String result = "";
        for (int i = 0; i < checkBoxesLessonsToPick.length; i++)
        {
            ...
            {
                int crClassID = GetClassIDByClassName(checkBoxesLessonsToPick[i].getText().toString());
    ...
    {
        int result = -1;
        for(int i = 0; i < LessonsAndClasses.CLASS_NAMES.length; i++)
        {
            if(LessonsAndClasses.CLASS_NAMES[i].equals(className))
            {
                return i;
            }
        }
    ...
    {
        userID = ServerHelper.GetUserIDByUserName(GlobalVariables.USER_NAME);
        ...
        Student crStudent = CreateStudentObjectBasedOnTheInfoInFields();

        AsyncTaskHelper.UploadMiniUserPhotoToDirectory(StudentRegisterActivity.this, getApplicationContext(), crStudent, bitmap,
        ...
        /*if(userID == -1)
        {
            //TODO with this error user needs to be uninstall and reinstall the app, improve the stuation by asking acceptance with alertDialog and reCreate the SQLite DB and than go to Lunch or SignUp Activity for user to start a fresh SignUp And Register
            GlobalVariables.AlertDialogDisplay(this, getString(R.string.register_warning_error_getting_user_name));
            return;
        }
        if((photoID = ServerHelper.RegisterUserPhotoToServer(getApplicationContext(), photoImage, this)) != -1)
        {
            Student crStudent = CreateStudentObjectBasedOnTheInfoInFields();
            if(ServerHelper.RegisterStudentToServer(crStudent, getApplicationContext()))
            {
                GlobalVariables.AlertDialogDisplay(StudentRegisterActivity.this, getString(R.string.register_response_succesful));
                isQuestionRequestPostedSuccessfully = true;
                buttonRegisterUser.setText(R.string.menu_main_manu);
            }
            else
            {
                new CustomToast(this, getApplicationContext(), getString(R.string.register_response_failed));
                isQuestionRequestPostedSuccessfully = false;
            }
        }
        else
        {
            new CustomToast(this, getApplicationContext(), getString(R.string.earnings_iban_no_send_failed));
            isQuestionRequestPostedSuccessfully = false;
        }*/
    }
    ...
    public void InsertSelectedClassesForTutor(int userID, String classSelections)
    {
        if(classSelections.isEmpty())
        {
            return;
        }
        String[] classIdsStrArray = classSelections.split(",");
        for(int i = 0; i < classIdsStrArray.length; i++)
        {
            try
            {
                int crClassID = Integer.parseInt(classIdsStrArray[i]);
                AsyncTaskHelper.InsertSelectedClassIDForTutor(getApplicationContext(), userID, crClassID);
            }
            catch (Exception ex)
            {
                //Do Nothing
    ...
    private Student CreateStudentObjectBasedOnTheInfoInFields()
    {
        Student result = new Student(name, surname, gender, birthDate, educationalAttainment, lastSchool, educationField, cityOfResidency, districtOfResidency, cityOfRegistry, districtOfRegistry, phoneNumber, userID, photoID, classSelections);
        return result;
    }


    private void FormatPhoneNumber(EditText editTextPhoneNumber)
    {
        ...
        //editTextPhoneNumber.addTextChangedListener(new PhoneNumberFormattingTextWatcher("^((\\+90)|(0090))-{0,1}\\d{3}-{0,1}\\d{7}$|^\\d{11}$|^\\d{4}-\\d{7}$"));
        //editTextPhoneNumber.setMask("+90(###) ###-##-##");
    ...
    void PopUpDateOfBirthSelectionDialog()
    {
        ...
        DatePickerDialog dialog = new DatePickerDialog(StudentRegisterActivity.this,
