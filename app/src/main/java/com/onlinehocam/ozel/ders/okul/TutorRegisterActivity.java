...
public class TutorRegisterActivity extends AppCompatActivity {
    ...
    EditText editTextTutorName, editTextTutorSurname, editTextBirthDate, editTextPhoneNumber, editTextLastSchool, editTextDepartment, editTextMinimumPrice, editTextIbanNo;
    ...
    private void HandleSpinnersOnPlaceOfResidency()
    {
        ...
        spinnerCityOfResidency.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                {
                    cityOfResidency = -1;
                    arrayAdapterDistrictOfResidency = new ArrayAdapter(TutorRegisterActivity.this, android.R.layout.simple_spinner_item, new String[]{ getString(R.string.register_please_select_city_first) });
                    spinnerDistrictOfResidency.setAdapter(arrayAdapterDistrictOfResidency);
                }
                else
                {
                    ...
                    arrayAdapterDistrictOfResidency = new ArrayAdapter(TutorRegisterActivity.this, android.R.layout.simple_spinner_item, CommonUtils.GetSpinnerStringArrayWithHeaderTitle(spinnerDistrictOfResidency, crDistricts, "") );
                    spinnerDistrictOfResidency.setAdapter(arrayAdapterDistrictOfResidency);
                }
            }
    ...
    private void HandleSpinnersOnPlaceOfRegistry()
    {
        ...
        spinnerCityOfRegistry.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                {
                    cityOfRegistry = -1;
                    arrayAdapterDistrictOfRegistry = new ArrayAdapter(TutorRegisterActivity.this, android.R.layout.simple_spinner_item, new String[]{ getString(R.string.register_please_select_city_first) });
                    spinnerDistrictOfRegistry.setAdapter(arrayAdapterDistrictOfRegistry);
                }
                else
                {
                    ...
                    arrayAdapterDistrictOfRegistry = new ArrayAdapter(TutorRegisterActivity.this, android.R.layout.simple_spinner_item, CommonUtils.GetSpinnerStringArrayWithHeaderTitle(spinnerDistrictOfRegistry, crDistricts, "") );
                    spinnerDistrictOfRegistry.setAdapter(arrayAdapterDistrictOfRegistry);
                }
            }
    ...
    private void InitializeComponents()
    {
        ...
        editTextMinimumPrice = findViewById(R.id.editTextMinimumPrice);
    ...
    private void SetOnClickListeners()
    {
        imageViewPhoto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    new CustomToast(TutorRegisterActivity.this, getApplicationContext(), getString(R.string.post_question_please_upload_question_photo));
                }
            }
        });
        buttonTakePhoto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    new CustomToast(TutorRegisterActivity.this, getApplicationContext(), getString(R.string.permission_check_camera_permission_is_needed));
                }
            }
        });
        buttonImportPhoto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    new CustomToast(TutorRegisterActivity.this, getApplicationContext(), getString(R.string.permission_check_read_external_storage_permission_is_needed));
                }
            }
        });
        ...
        textViewReadUserAgreement.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                GlobalVariables.AlertDialogDisplay(TutorRegisterActivity.this, GlobalVariables.TUTOR_USER_AGREEMENT);
            }
        });
    }
    ...
    private void CheckIfFieldsFilledAndExecuteRegisteringUserIfNeeded()
    {
        ...
        if(editTextMinimumPrice.getText().toString().isEmpty() || !CommonUtils.DoubleTryParse(getApplicationContext(), editTextMinimumPrice.getText().toString()))
        {
            minimumPrice = 0.0;
        }
        else
        {
            minimumPrice = Double.parseDouble(editTextMinimumPrice.getText().toString());
        }
        ...
        {
            warningMessage = getString(R.string.register_warning_please) + " " + (getString(R.string.register_tutor_prefered_classes_for_tutoring)).substring(0,getString(R.string.register_tutor_prefered_classes_for_tutoring).length()-1) + " " + getString(R.string.fill_the_field);
            new CustomToast(this, getApplicationContext(), warningMessage);
        }
        ...
        else if(minimumPrice == 0.0)
        {
            warningMessage = getString(R.string.register_warning_enter_min_price);
            new CustomToast(this, getApplicationContext(), warningMessage);
        }
        else if(minimumPrice < 0.5 || minimumPrice > 2.5)
        {
            //TODO add an extensive and couraging explenation of earning bonuses of solution display in an Alert dialog Box
            warningMessage = getString(R.string.register_warning_min_price_range);
            new CustomToast(this, getApplicationContext(), warningMessage);
        }
    ...
    private void RegisterUser()
    {
        ...
        if(userID == -1)
        {
            ...
            SoundHelper.PlayMediaPlayerSound(TutorRegisterActivity.this, SoundHelper.SOUNDS.CONNECTION_FAILED);
        ...
        Tutor crTutor = CreateTutorObjectBasedOnTheInfoInFields();

        AsyncTaskHelper.UploadMiniUserPhotoToDirectory(TutorRegisterActivity.this, getApplicationContext(), crTutor, bitmap,
...
/*
        if((photoID = ServerHelper.RegisterUserPhotoToServer(getApplicationContext(), photoImage, this)) != -1)
        {
            ...
            if(ServerHelper.RegisterUserToServer(crTutor, getApplicationContext(), this))
            {
                GlobalVariables.AlertDialogDisplay(TutorRegisterActivity.this, getString(R.string.register_response_succesful));
                InsertSelectedClassesForTutor(crTutor.userID, crTutor.classSelections);
    ...
    private Tutor CreateTutorObjectBasedOnTheInfoInFields()
    {
        Tutor result = new Tutor(name, surname, gender, birthDate, educationalAttainment, lastSchool, educationField, cityOfResidency, districtOfResidency, cityOfRegistry, districtOfRegistry, phoneNumber, userID, photoID, IBANNo, classSelections);
        return result;
    }
    ...
    void PopUpDateOfBirthSelectionDialog()
    {
        ...
        DatePickerDialog dialog = new DatePickerDialog(TutorRegisterActivity.this,
