...
public class TutorQuestionRequestDisplayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tutor_question_request_display);
    ...
    {
        questionRequestIDsListAllInOne = ServerHelper.GetQuestionRequestIDsForTheGivenTutorID(GlobalVariables.USER_ID);
    ...
    private void FillData()
    {
        ...
        for(int i = 0; i < GlobalVariables.questionRequestStatusAccordingToTutors.length; i++)
        {
            questionRequestCategories.add(getString(GlobalVariables.questionRequestStatusAccordingToTutors[i]));
        }
        ...
        {
            //GlobalVariables.Log(getApplicationContext(), "questionRequestIDsListAllInOne.get(i): "+ questionRequestIDsListAllInOne.get(i));
