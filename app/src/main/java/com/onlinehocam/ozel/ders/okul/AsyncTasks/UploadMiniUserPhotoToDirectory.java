...
class UploadMiniUserPhotoToDirectory  extends AsyncTask<String, Void, String> {
    ...
    public UploadMiniUserPhotoToDirectory(Activity activity, Context context, Tutor tutor, Bitmap bitmap, String photo_data_address_id, LinearLayout linearLayoutMainProgressBar, LinearLayout linearLayoutButtonRegisterUser, boolean isToDisplayProgressBarOnPreExecute, boolean isToDismissProgressBarOnPostExecute) {
    ...
    public UploadMiniUserPhotoToDirectory(Activity activity, Context context, Student student, Bitmap bitmap, String photo_data_address_id, LinearLayout linearLayoutMainProgressBar, LinearLayout linearLayoutButtonRegisterUser, boolean isToDisplayProgressBarOnPreExecute, boolean isToDismissProgressBarOnPostExecute) {
        this.activity = activity;
        this.context = context;
        this.photo_data_address_id = photo_data_address_id;
        this.linearLayoutMainProgressBar = linearLayoutMainProgressBar;
    ...
    public UploadMiniUserPhotoToDirectory(Activity activity, Context context, Marketer marketer, Bitmap bitmap, String photo_data_address_id, LinearLayout linearLayoutMainProgressBar, LinearLayout linearLayoutButtonRegisterUser, boolean isToDisplayProgressBarOnPreExecute, boolean isToDismissProgressBarOnPostExecute) {
        this.activity = activity;
        this.context = context;
        this.photo_data_address_id = photo_data_address_id;
        this.linearLayoutMainProgressBar = linearLayoutMainProgressBar;
    ...
    protected void onPostExecute(String result) {
        ...
        if(tutor != null)
        {
            if(photoID != -1)
            {
                ...
                AsyncTaskHelper.UploadUserPhotoToDirectory(activity, context, tutor, bitmap,
                        photoDataAddressID, linearLayoutMainProgressBar, linearLayoutButtonRegisterUser,false, false);
            }
            else
            {
        ...
        else if(student != null)
        {
            if(photoID != -1)
            {
                ...
                AsyncTaskHelper.UploadUserPhotoToDirectory(activity, context, student, bitmap,
                        photoDataAddressID, linearLayoutMainProgressBar, linearLayoutButtonRegisterUser,false, false);
            }
            else
            {
        ...
        else if(marketer != null)
        {
            if(photoID != -1)
            {
                ...
                AsyncTaskHelper.UploadUserPhotoToDirectory(activity, context, marketer, bitmap,
                        photoDataAddressID, linearLayoutMainProgressBar, linearLayoutButtonRegisterUser,false, false);
            }
            else
            {
